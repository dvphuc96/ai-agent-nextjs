  ...
  return (
    <div className="flex-1 flex items-center justify-center p-4">
      <div className="relative max-w-2xl w-full">
        <div className="absolute inset-0 -z-10 bg-gradient-to-r from-blue-100 to-gray-50/50 rounded-3xl"></div>
        ...
        <div className="relative space-y-6 p-8 text-center">
          <div className="bg-white/60 backdrop-blur-sm shadow-sm ring-1 ring-gray-200/50 rounded-2xl p-6 space-y-4">
            ...
            <h2 className="text-2xl font-semibold bg-gradient-to-br from-gray-900 to-gray-600 text-transparent bg-clip-text">
              Welcome to the AI Agent Chat
            </h2>
            <p className="text-gray-600">
              Start a new conversation or select an existing chat from the side
              bar.
              <br />
